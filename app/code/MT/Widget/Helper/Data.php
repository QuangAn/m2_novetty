...
//        }
    ...
    public function getProducts($type = 'collection', $value = 'latest', $params, $limit=10){
        $collection = null;
    ...
    protected function _getProductCategoryCollection($category) {
        ...
        if (!$category instanceof \Magento\Catalog\Model\Category){
            ...
            $categoryModel = $categoryModel->load($category, array('entity_id'));
