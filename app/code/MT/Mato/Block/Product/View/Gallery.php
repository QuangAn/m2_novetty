 ...
 */
namespace MT\Mato\Block\Product\View;
...
class Gallery extends \Magento\Catalog\Block\Product\View\AbstractView
{
    ...
    public function __construct(
        ...
        \MT\Mato\Helper\Image $matoHelper,
        array $data = []
    ) {
    ...
    {
        /* Image size */
        if(!($main_width = $this->_matoHelper->getConfig('product_page/main_image_width')))
            $main_width = $this->getImageAttribute('product_page_image_medium', 'width');

        if(!($thumb_width = $this->_matoHelper->getConfig('product_page/thumb_image_width')))
            $thumb_width = $this->getImageAttribute('product_page_image_small', 'width');
            ...
            foreach ($images as $image) {
                ...
                $image->setData(
                    ...
                    $this->_imageHelper->init($product, 'product_page_image_small')
                        ...
                        ->constrainOnly(false)->keepAspectRatio(true)->keepFrame(false)
                        ->resize($thumb_width)
                        ->getUrl()
                );
                $image->setData(
